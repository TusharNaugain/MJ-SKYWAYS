    ...
    <footer>
      <div className="container">
        <div className="ft-g">
          ...
          <div className="ft-col"><h4>Contact</h4><ul><li><a href="mailto:info@mjskyways.com">info@mjskyways.com</a></li><li><a href="tel:+919844247595">+91 98442 47595</a></li><li><a href="#contact">Send a Message</a></li></ul></div>
        </div>
